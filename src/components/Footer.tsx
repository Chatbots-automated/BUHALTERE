        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-xl font-bold">SecretaryPro</span>
            </div>
            <p className="text-neutral-300 mb-4">
              Professional secretary services to streamline your business operations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral-300">123 Business Ave, Suite 100, New York, NY 10001</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-neutral-300">info@secretarypro.com</span>
              </li>
            </ul>
          </div>
        </div>
